...
export default function Home() {
  ...
  return (
    <div style={{ height: "100vh", width: "100vw", overflow: "hidden", position: "relative" }}>
      ...
      >
        <h5 className="mb-0 fw-bold d-flex align-items-center gap-2" style={{ pointerEvents: "auto", flexShrink: 0 }}>
          <span className="text-danger" style={{ letterSpacing: "2px", textShadow: activeTab === "map" ? "0 1px 8px rgba(0,0,0,0.5)" : "none" }}>WAR</span>
          <small className="d-none d-lg-inline" style={{ fontSize: "0.6rem", letterSpacing: "0.5px", color: "rgba(255,255,255,0.35)" }}>
            GLOBAL CONFLICT MONITOR
          </small>
        </h5>
        <Nav variant="pills" className="ms-auto gap-1 flex-nowrap nav-mobile-scroll" style={{ pointerEvents: "auto", overflowX: "auto", overflowY: "hidden", WebkitOverflowScrolling: "touch" }}>
          {TABS.map((tab) => (
      ...
      <div style={{ height: "100%", width: "100%" }}>
        ...
        {activeTab !== "map" && (
          <Container
            ...
            style={{ height: "100%", paddingTop: 52, paddingLeft: 12, paddingRight: 12, paddingBottom: 16 }}
          >
